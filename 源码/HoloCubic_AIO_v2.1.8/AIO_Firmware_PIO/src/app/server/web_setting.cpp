...
void init_page_header()
{
    ...
    webpage_header += F("<title>SimonCubic WebServer</title>"); // NOTE: 1em = 16px
    ...
    webpage_header += F("<h1>Simon_Cubic");
...
void HomePage()
{
    ...
    webpage = F("<a href='https://blog.cccg.top' target='_blank'><button>BLOG</button></a>");
    Send_HTML(webpage);
}
